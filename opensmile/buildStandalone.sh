...
#export CXXFLAGS="-O0"
#export CFLAGS="-O0"
#export CPPFLAGS="-D_DEBUG -g -D__STATIC_LINK -DBUILD_WITH_GPL3rdP -DBUILD_LIBSVM -DBUILD_RNN -DBUILD_WITHOUT_EXPERIMENTAL"
## non-debug flags:
export CXXFLAGS="-O2"
export CFLAGS="-O2"
export CPPFLAGS="-D__STATIC_LINK -DBUILD_WITH_GPL3rdP -DBUILD_LIBSVM -DBUILD_RNN -DBUILD_WITHOUT_EXPERIMENTAL"
#####
