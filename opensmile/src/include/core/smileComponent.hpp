...
public:
  ...
  cComponentMessage(const char *_type=NULL, const char *_name=NULL) :  msgid(-1), sender(NULL), smileTime(0.0), readerTime(-1.0), userflag1(0), userflag2(0), userflag3(0), custData(NULL), custData2(NULL), custDataSize(0), custData2Size(0) {
