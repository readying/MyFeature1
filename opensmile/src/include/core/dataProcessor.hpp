...
class DLLEXPORT cDataProcessor : public cSmileComponent {
  ...
  protected:
    ...
    // (optional) fullName = 1: match full field name instead of part of name
    long findField(const char *namePartial, int fullName=0, long *N=NULL, const char **fieldName=NULL, long nEl=-1, int *more=NULL);
    ...
    //
    long findElement(const char *namePartial, int fullName, long *N, const char **fieldName, int *more);
