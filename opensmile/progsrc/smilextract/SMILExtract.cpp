...
int main(int argc, char *argv[])
{
  try {
	  ...
	  char * myargv[6];
	  myargv[0]="-I" ;
	  myargv[1]= "E:\opensmile-2.0-rc1\msvcbuild";
	  myargv[2]="-C";
	  myargv[3]="E:\\opensmile-2.0-rc1\\msvcbuild\\MFCC12_0_D_A.conf";
	  myargv[4]="-O";
	  myargv[5]="E:\\opensmile-2.0-rc1\\msvcbuild\\o1.csv";
    ...
    // commandline parser:
    cCommandlineParser cmdline(6,myargv);
